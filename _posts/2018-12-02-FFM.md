...
<p class="auto-cursor-target"><br /></p><ac:structured-macro ac:name="info" ac:schema-version="1" ac:macro-id="547da65a-7df0-4f8e-9b3b-abe0fad07fe5"><ac:parameter ac:name="title">참고자료</ac:parameter><ac:rich-text-body>
<ul class="ul1">
<li class="li1">
...
<p><ac:image ac:border="true" ac:height="72" ac:width="600"><ri:attachment ri:filename="스크린샷 2018-12-02 오후 3.17.09.png" /></ac:image></p></li>
<li>
...
<ul>
<li>그러나 결과는 유효성 검사 세트를 사용하여 조기에 중단 한 결과만큼 성공적이지 못합니다.</li></ul></li></ul>
<p><br /></p>
